        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                List<int> arrOfNumericValues = numStr.
                                               ...
                                               ToList().      // <= Convert array List in order to use Linq to be able to convert each char to integer
                                               ConvertAll(
                ...
                string resultStr = string.Join(
                                    ...
                                    arrOfNumericValues.
                                        Select(
                                            // Take each number and map against their respective value in the dictionary. E.g. 1 => "one"
